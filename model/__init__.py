...
class Model(nn.Module):
    def __init__(self, args, ckp):
        ...
        print('Making model...')
        self.args = args
        self.cpu = args.cpu #use cpu only
        self.chop = args.chop # enable memory-efficient forward
        self.device = torch.device('cpu' if args.cpu else 'cuda')
        self.n_GPUs = args.n_GPUs
        self.ckp = ckp # logger 
        self.save_models = args.save_models # store true

        module = import_module('model.' + args.model.lower()) #default DEBLUR
